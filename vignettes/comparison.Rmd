...
In this instance (and in others we have explored), results from `phylolm::phyloglm` are generally different while those from `phylosem` and `phyr::pglmm_compare` are close but not identical.
...
Based on these two comparisons, we encourage further cross-testing of different phylogenetic generalized linear models.
