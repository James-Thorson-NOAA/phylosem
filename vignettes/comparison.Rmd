...
```{r, echo=TRUE, message=FALSE, fig.width=6, fig.height=6, out.width = "75%", echo=FALSE}
library(ggplot2)
figure = readRDS( file.path(R'(C:\Users\James.Thorson\Desktop\Git\phylosem\vignettes)',"brms.RDS") )
figure
```
