...
```{r, eval=have_packages, echo=TRUE, results='hide', message=FALSE, fig.width=6, fig.height=6}
# Load packages
library(phylosem)
library(fishtree)
...
```{r, eval=have_packages, echo=FALSE, message=FALSE, fig.width=6, fig.height=6}
