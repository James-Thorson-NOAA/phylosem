...
# Build
#  setwd( R'(C:\Users\James.Thorson\Desktop\Git\phylosem)' ); devtools::build_rmd("vignettes/demonstration.Rmd")
# Compile PDF
#  library(rmarkdown); render( "vignettes/demonstration.Rmd", pdf_document())
```
...
# Simulate tree
set.seed(1)
Time_rcz = array(NA, dim=c(Nreplicates,length(Ntree_config),2),
                 dimnames=list(NULL,"tree_size"=Ntree_config,"package"=c("phylolm","phylosem")) )
