...
Sys.time() - start_time
#> Time difference of 0.005527973 secs
...
Sys.time() - start_time
#> Time difference of 0.1439321 secs
...
Sys.time() - start_time
#> Time difference of 0.01290703 secs
...
psem_ou = phylosem( sem = "x -> y, p",
          ...
          control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.1729405 secs
...
Sys.time() - start_time
#> Time difference of 0.02311301 secs
...
psem_lambda = phylosem( sem = "x -> y, p",
          ...
          control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.1303182 secs
...
Sys.time() - start_time
#> Time difference of 0.006993294 secs
...
psem_kappa = phylosem( sem = "x -> y, p",
          ...
          control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.1263106 secs
...
Sys.time() - start_time
#> Time difference of 0.01126456 secs
plot(result)
```
...
psem = phylosem( sem = model,
          ...
          control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.7410967 secs
...
Sys.time() - start_time
#> Time difference of 0.01864386 secs
...
psem = phylosem( data = Data,
          ...
          control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.06046033 secs
```
...
Sys.time() - start_time
#> Time difference of 0.1055248 secs
...
psem = phylosem( data = Data,
                 ...
                 control = phylosem_control(quiet = TRUE) )
Sys.time() - start_time
#> Time difference of 0.577347 secs
